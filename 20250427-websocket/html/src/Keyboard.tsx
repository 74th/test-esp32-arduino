...
export function Keyboard({ ws }: { ws: WebSocketConnector }) {
  return (
    <div style={{ width: "100%", height: "100%" }}>
      ...
      >
        <Key text="=%/" code="SPACE" ws={ws} width="20%"></Key>
        <ModifierKey
          text="CTL"
          keyName="ctrl"
          ws={ws}
        ...
        <ModifierKey text="ALT" keyName="alt" ws={ws} width="10%"></ModifierKey>
        <ModifierKey text="WIN" keyName="win" ws={ws} width="10%"></ModifierKey>
